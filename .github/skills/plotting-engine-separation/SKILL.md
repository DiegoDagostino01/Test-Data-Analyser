...
description: "Use when: refactoring plotting, FFT, axis limits, legends, figure export, Matplotlib rendering, cursor plot data, or data preparation."
---
...
- Keep data preparation in `services/plotting_data_service.py`,
  `services/fft_service.py`, `services/plot_render_service.py`, or
  `viewmodels/plot_workspace_vm.py` when practical.
...
- Preserve analysis-window filtering, low-pass filtering, FFT plotting, cursor
  point comparison, manual/auto axis limits, axis padding settings, limit-line
